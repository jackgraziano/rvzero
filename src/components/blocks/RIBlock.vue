<template>
  <div class="ri-block">
    <ComparisonBlockHeader
      ...
      title="BLOCO RI — RESTRIÇÕES DE ITAIPU"
            ...
            <table class="data-table">
              <thead>
                <tr>
                  ...
                  <th @click="sortBy('usina')" class="sortable" v-sortable-header>Usina{{ getSortIcon('usina') }}</th>
                  <th @click="sortBy('subsistema')" class="sortable" v-sortable-header>Subsist{{ getSortIcon('subsistema') }}</th>
